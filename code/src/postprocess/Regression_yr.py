...
class ExperimentRunner:
    ...
    # @staticmethod
    def aggregate_prediction_ra(self, df: pd.DataFrame, control_confidence=False) -> pd.DataFrame:
        results_dir = self.config.get('res_dir', None)
        info_path = os.path.join(results_dir, 'all_info.csv')
        info_all = pd.read_csv(info_path)
    ...
    def load_and_prepare_data(
        ...
        for dataset in datasets:
            ...
            result_file = f'{results_dir}/res/{dataset}_results.csv'
